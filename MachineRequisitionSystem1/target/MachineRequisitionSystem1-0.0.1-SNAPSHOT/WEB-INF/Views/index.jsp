...
<<<<<<< HEAD
	<head>
		...
		<spring:url value="/resources/js/jqueryValidation.js" var="jqueryVal"/>
							...
							<div class="form-group">
      							...
      							<div class="col-sm-6">
      								<div class="input-group">
        								...
        								<input type="text" class="form-control" placeholder="XY123456" required name="userid" id="userid">
     							...
     							<label class="control-label col-sm-3" for="fromDate">Start Date:</label>
      							<div class="col-sm-6">
      								<div class="input-group">
        								...
        								<input type="text" class="form-control" required name="fromDate" id="fromDate">
      								</div>
      							</div>
    						</div>
							...
							<div class="form-group">
     							...
     							<div class="col-sm-6">
     								<div class="input-group">
        								...
        								<input type="text" class="form-control" required name="toDate" id="toDate">
      								</div>
      							</div>
    						</div>
	                      <div class="form-group">
...
<body
	...
	<div class="container">
		...
		<form class="form-horizontal form-style background-format"
			method="post" name="form1" action="request.save"
			modelAttribute="request" onsubmit="return checkAllFields()">
			<img src="${logo}" class="img-responsive ">
			<table class="table">
				<tr>
					<td id="form-table"><label id="detail">Enter the
							following details</label>

						<div class="form-group">
							<label class="control-label col-sm-3" for="option">Select
								input type</label>
							<div class="col-sm-6">
								<select class="form-control" id="option" required>
									<option value="" selected disabled>Select Option</option>
							...
							<div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-modal-window"></i>
									</span> <input disabled type="text" class="form-control"
										onkeypress="return isIp(event)" required name="credential"
										id="ip" autocomplete="off"> <input disabled
										type="text" class="form-control" required name="credential"
										id="server" autocomplete="off"> <span
										class="input-group-addon " id="wrong1"
										style="background-color: white;"> <i
										class="glyphicon glyphicon-remove-circle"></i>
									</span> <span class="input-group-addon " id="right1"
										style="border: none;"> <i
						...
						<div class="form-group">
							<label class="control-label col-sm-3" for="userid">Requestor
								ID</label>
							<div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-user"></i>
									</span> <input type="text" class="form-control" placeholder="XY123456"
										required name="associd" id="userid" autocomplete="off">
									<input type="text" id="useriddummy"> <span
										class="input-group-addon " id="wrong2"
										style="background-color: white;"> <i
										class="glyphicon glyphicon-remove-circle"></i>
									</span> <span class="input-group-addon " id="right2"
										style="border: none;"> <i
										class="glyphicon glyphicon-ok-circle"></i>
									</span>
								</div>
						...
						<div class="form-group">
							<label class="control-label col-sm-3" for="fromDate">Start
								Date:</label>
							<div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon"> <i
										...
										name="startdate" id="fromDate" autocomplete="off">
								</div>
							</div>
						</div>

						<div class="form-group">
							<label class="control-label col-sm-3" for="toDate">End
								Date:</label>
							<div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon"> <i
										...
										name="enddate" id="toDate" autocomplete="off">
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="did">Division
								Name:</label>
							<div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-user"></i>
									</span> <input type="text" class="form-control" id="did" required
										name="did" disabled> <input type="hidden"
										name="divname" id="hiddenId" value="">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-12">
								<input type="reset" class="btn btn-primary" value="Reset"
									onclick="reset_all()">&nbsp;&nbsp;&nbsp; <input
									type="submit" class="btn btn-success" value="Request">
							</div>
						</div></td>
					<td><Label class="notes">Note</Label>
						<ul class="notepoints">
							<li>You can request only one machine at a time</li>
							<li>Your request can be accepted or rejected based on the
								tenure of machine requisition request</li>
						</ul></td>
				</tr>
			</table>
		</form>
