...
public class MachineCredentialServiceTest {
	...
	public void testip() {
		...
		Mockito.when(machinedao.getDivisionNamebyIP(mc.getIpAddress())).thenReturn(mc.getDivisionName());
		Assert.assertEquals(machinecredentialservice.getDivisionNamebyIP(mc.getIpAddress()), mc.getDivisionName());
	}
	...
	public void testserver() {
		...
		Mockito.when(machinecredentialservice.getDivisionNamebyServer(mc.getServername()))
				.thenReturn(mc.getDivisionName());
	}
}
